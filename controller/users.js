...
exports.addShow = async (req, res) => {
  ...
  try {
    ...
    logger.debug(
      'recommendations controller : listRecommendations : Input Validation'
    );
    ...
    logger.error(
      'recommendations controller : listRecommendations: catch %o',
      error
    );
    res.status(500);
    res.json({
...
let createInputValidation = async body => {
  ...
  if (result.error) {
    logger.error(
      'recommendations controller : createCategory : Input Validation error %o',
      result.error
    );
    return {
    ...
    logger.info(
      'recommendations controller : createCategory : Input Validation success'
    );
    return false;
  }
};
